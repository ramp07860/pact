...
<header class="header">
    ...
    <div class="header-1">
        ...
        <form action="" class="search-form">
            <input class="border-none" type="search" name="" placeholder="search here..." id="search-box">
...
<section class="featured" id="featured">
    ...
    <div class="grid grid-cols-5 gap-1" :set="n=0">

        
        
        <div v-for="product in products" :n="n++" class="mt-2 max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="book">                
                <div class="card">
                    <div class="imgBox">
                        ...
                        <img class="p-8 rounded-t-lg" v-bind:src="'image/book-'+ n +'.png'" alt="product image" />
                        <element v-if="n>9" class="hidden"> {{n=0}}</element>
                    </div>
                    <div class="details">
                        <!-- <img src="image/book-2.png" style="width:100%"> -->
                        <ul class="m-20 mt-20">
                            <li class="text-black text-2xl my-4">{{product.title}}</li>
                            <li class=" flex my-4">
...
<!-- <ul>
<li v-for="product in products" :key="item">
    {{product.id}} ---------- 
    {{product.title}} ---------- 
...
<script>
    ...
    async created(){
        const response = await fetch("https://api.packt.com/api/v1/products", {
            method: 'GET',
    ...
    //     index( ){
    //         fetch( 'https://api.packt.com/api/v1/products', {
    //             method: 'GET',
    //             headers: APISettings.headers
    //         } )
